...
function RedirectHandler() {
  ...
  useEffect(() => {
    ...
    if (redirectPath) {
      delete sessionStorage.redirect; // Prevent future redirects
      navigate(redirectPath); // Use React Router to navigate
    }
  }, [navigate]);

  return null; // This component does not render anything, only handles redirection
}
