...
const ContactPage = () => {
  const denverTimeZone = 'America/Denver'; // Denver's timezone
  
  // Get the current time in Denver's timezone in 24-hour format
  const denverTime = new Date().toLocaleTimeString('en-US', {
  ...
  const formattedOffset = `UTC ${utcOffset >= 0 ? '+' : ''}${utcOffset}:00`;
  return (
    <HelmetProvider>
      <div>
        <Helmet>
                ...
                <div className={styles.profileInfo}>
                  ...
                  <div className={styles.contactContainer}>
                    ...
                    <div className={styles.infoRow}>
                      ...
                      <span className={styles.infoText}>Time: {denverTime} ({formattedOffset})</span>
                    </div>
                    <div className={styles.infoRow}>
                      <svg style={{ width: '16px', height: '16px' }} aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" className="octicon octicon-location">
